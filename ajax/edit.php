...
<form action="update.php" method="post" class="form" enctype="multipart/form-data" onsubmit="return form_control();">
		  ...
		  <div class="error" id="errorname" style="display:none">Please enter name.</div>
                ...
                <div class="group">
                  ...
                  <input type="text" class="text_field" name="email_address"  id="email" value="<?php echo isset($_POST['email_address'])?$_POST['email_address']:''; ?>"/>
                  <span class="description">Ex: a simple text</span>
		...
		<div class="group">
		  ...
		  <div>
		          <input type="radio" class="text_field" name="gender" id="gender1" value="M" <?php echo isset($_POST['gender']) && $_POST['gender']=='male'?'checked':''; ?> />
		          <label class="radio">Male</label>&nbsp;
			  <input type="radio" class="text_field" name="gender" id="gender2" value="F" <?php echo isset($_POST['gender']) && $_POST['gender']=='female'?'checked':''; ?> />
